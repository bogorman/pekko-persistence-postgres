...
package pekko.persistence.postgres.journal
...
import pekko.persistence.postgres.journal.dao.JournalMetadataTable
import pekko.persistence.postgres.query.ScalaPostgresReadJournalOperations
import pekko.persistence.postgres.util.Schema._
import pekko.persistence.postgres.util.{ ClasspathResources, DropCreate }
