...
import pekko.persistence.postgres.query.EventAdapterTest.{ Event, EventRestored, TaggedAsyncEvent, TaggedEvent }
import pekko.persistence.postgres.query.EventsByTagTest._
